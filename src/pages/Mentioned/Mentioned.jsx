...
const Mentioned = () => {
    ...
    const mentioned = boards.filter(eachBoard => eachBoard.mentioned.includes(user.email) === true)
    ...
    return (
        <div>
            <HeadingOfPage heading={"Mentioned Board"}></HeadingOfPage>
            <div className='grid grid-cols-1 lg:grid-cols-3 gap-6 mt-8'>
                {
                    mentioned.map(singleItem => <div
                        key={singleItem._id}
